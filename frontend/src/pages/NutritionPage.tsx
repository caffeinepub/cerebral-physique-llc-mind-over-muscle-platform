...
import { Lock, Calendar, User, Leaf, ArrowRight } from 'lucide-react';
import { useGetPublishedNutritionArticlePreviews, useGetMyMembership, useIsCallerAdmin } from '../hooks/useQueries';
import { useInternetIdentity } from '../hooks/useInternetIdentity';
import { Badge } from '@/components/ui/badge';
import { Skeleton } from '@/components/ui/skeleton';

export default function NutritionPage() {
  const { data: previews = [], isLoading } = useGetPublishedNutritionArticlePreviews();
      ...
      <section className="relative py-16 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-4 py-1.5 mb-4">
            ...
            <span className="text-sm font-medium text-primary">Nutrition Hub</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
            Fuel Your Performance
          </h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Science-backed nutrition guidance to complement your training and optimize your results.
          </p>
        </div>
      </section>
