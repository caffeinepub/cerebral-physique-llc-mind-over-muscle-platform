...
import { Check, Edit2, Image, Plus, Trash2, Video, X } from "lucide-react";
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setForm({ ...form, primaryMuscle: v as MuscleGroup })
                  }
                >
              ...
              <div className="space-y-1.5">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setForm({ ...form, equipmentType: v as EquipmentType })
                  }
                >
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, isPlaceholder: e.target.checked })
                }
                    ...
                    <div className="flex gap-3 mt-1.5 text-xs text-muted-foreground">
                      {exercise.media?.imageUrls?.length > 0 && (
                        <span className="flex items-center gap-1">
                          ...
                          {exercise.media.imageUrls.length} image
                          {exercise.media.imageUrls.length !== 1 ? "s" : ""}
                        </span>
                      )}
                      {exercise.media?.videoUrls?.length > 0 && (
                        <span className="flex items-center gap-1">
                          <Video className="w-3 h-3" />
                          {exercise.media.videoUrls.length} video
                          {exercise.media.videoUrls.length !== 1 ? "s" : ""}
                        </span>
                      )}
                    </div>
                  </div>
